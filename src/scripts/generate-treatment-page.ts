// Helper script to generate treatment page template
// This is a reference template for creating new treatment pages

export const treatmentPageTemplate = (treatmentName: string, slug: string, description: string, category: string) => {
  return `"use client";
...
const faqs = [
  {
    question: "What is ${treatmentName} and how does it work?",
    answer: "${description}"
  },
  {
    question: "How long do ${treatmentName} results last?",
  ...
  {
    question: "Is ${treatmentName} treatment painful?",
  ...
  {
    question: "Who is a good candidate for ${treatmentName}?",
...
export default function ${treatmentName.replace(/\s+/g, '')}Page() {
            ...
            >
              <div className="bg-gradient-to-br from-pastel-green/30 to-pastel-pink/30 rounded-2xl p-8 aspect-square flex items-center justify-center overflow-hidden mb-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 font-medium">${treatmentName}</p>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          >
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600">
                Why choose ${treatmentName} for your treatment needs
              </p>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600">
                Common questions about ${treatmentName} treatment
              </p>
            </div>
      ...
      <section className="py-20 bg-gradient-to-r from-pastel-green/30 to-pastel-pink/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600">
              Book your ${treatmentName} consultation with Dr. Jaishree and take the first step 
