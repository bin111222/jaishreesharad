      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto text-lg text-gray-600 leading-relaxed space-y-4">
            <p>
              Dr Jaishree completed her MBBS in 1995 from the Mahatma Gandhi Institute of Medical Sciences (MGIMS), Sevagram, followed by a postgraduate degree in Dermatology in 1999 from Mumbai. To further advance her expertise, she pursued a fellowship in Laser Surgery from Bangkok and a fellowship in Cosmetic Dermatology from the USA.
            </p>
            <p>
              She has trained under some of the world’s most eminent leaders in aesthetic dermatology, including Dr. Steve Mandy, Dr. Zoe Draelos, Dr. Leslie Baumann, Dr. Rebecca Fitzgerald (USA), Dr. Gerhard Sattler (Germany), Dr Niwat Polnikorn ( Bangkok), Dr Satish Savant ( Mumbai).
            </p>
            <p>
              Over the past 26 years, she has remained deeply committed to continuous learning, regularly attending international workshops every year to ensure her practice reflects the most current and globally accepted standards of dermatology.
            </p>
          </div>
        </div>
      </section>
