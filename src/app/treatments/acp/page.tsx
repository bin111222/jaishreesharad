...
const faqs = [
  {
    question: "What is ACP and how does it work?",
    answer: "ACP (Autologous Conditioned Plasma) is a natural hair restoration treatment that uses your own blood plasma enriched with growth factors and platelets. A small amount of blood is drawn, processed to concentrate platelets and growth factors, and then injected into the scalp. These growth factors stimulate hair follicles, promote new hair growth, improve hair density, and enhance the quality of existing hair."
  },
  {
    question: "How long do ACP results last?",
  ...
  {
    question: "Is ACP treatment painful?",
  ...
  {
    question: "Who is a good candidate for ACP?",
    answer: "Ideal candidates are adults experiencing hair loss, thinning hair, or seeking to improve hair density and quality. ACP is suitable for both men and women and can be used for various types of hair loss including androgenetic alopecia, telogen effluvium, or general hair thinning. We'll assess your hair condition during consultation."
  },
  {
  ...
  {
    question: "When will I see results?",
    answer: "Some patients notice improvements in hair quality and reduced shedding within 4-8 weeks. Visible hair growth typically appears after 8-12 weeks, with full results developing over 4-6 months as new hair grows. Results continue to improve with each session."
  },
  {
    question: "Is ACP treatment painful?",
  ...
  },
  {
    ...
    answer: "Common side effects include mild redness, swelling, or tenderness at injection sites that typically resolve within a few hours. Some patients may experience minor bruising. Since ACP uses your own blood, there's minimal risk of allergic reactions. Serious side effects are rare."
  },
  {
    question: "How does ACP differ from PRP?",
    answer: "ACP (Autologous Conditioned Plasma) is a specific type of PRP preparation that uses a specialized system to concentrate platelets and growth factors. ACP may have a higher concentration of beneficial factors compared to traditional PRP, potentially providing enhanced results. Both use your own blood plasma."
  },
  {
    question: "Can ACP be combined with other hair treatments?",
    answer: "Yes, ACP can be combined with other treatments like minoxidil, finasteride, laser therapy, or hair transplant procedures for comprehensive hair restoration. We'll create a personalized treatment plan during your consultation."
  },
  {
...
const benefits = [
  ...
  "No synthetic chemicals or medications",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                ACP (Autologous Conditioned Plasma) is an advanced hair restoration treatment that uses your own blood plasma enriched with growth factors and platelets. This natural, regenerative therapy stimulates hair follicles, promotes new hair growth, and improves hair density and quality without the use of synthetic chemicals or medications.
              </p>
            ...
            >
             <div className="bg-gradient-to-br from-pastel-green/30 to-pastel-pink/30 rounded-2xl p-8 aspect-square flex items-center justify-center overflow-hidden mb-6">
                <img 
                  src="https://ik.imagekit.io/jaishreeskinfinitii/websiteimages/acp/acp.webp"
          ...
          >
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                ACP provides comprehensive benefits for hair growth and restoration using your body's natural healing factors.
              </p>
            </div>
          ...
          >
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600">
                Understanding the natural hair restoration process
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-r from-pastel-green/10 to-pastel-pink/10 rounded-xl p-6">
                ...
                <p className="text-gray-700">
                  A small amount of blood is drawn from your arm, similar to a routine blood test. The blood 
                  is then processed using a specialized system that separates and concentrates platelets and 
                  growth factors, creating ACP (Autologous Conditioned Plasma) rich in healing factors.
                </p>
              </div>
              
              <div className="bg-gradient-to-r from-pastel-pink/10 to-pastel-green/10 rounded-xl p-6">
                <h3 className="font-semibold text-lg text-gray-800 mb-3">2. Scalp Injection</h3>
                <p className="text-gray-700">
                  The concentrated ACP is injected into the scalp in areas experiencing hair loss or thinning. 
                  The injection process creates micro-injuries that trigger the body's natural healing response, 
                  while the growth factors directly stimulate hair follicles.
                </p>
              </div>
              
              <div className="bg-gradient-to-r from-pastel-green/10 to-pastel-pink/10 rounded-xl p-6">
                <h3 className="font-semibold text-lg text-gray-800 mb-3">3. Follicle Stimulation</h3>
                <p className="text-gray-700">
                  The growth factors in ACP (including PDGF, VEGF, EGF, and others) activate hair follicles, 
                  particularly those in the dormant or miniaturized phase. These factors promote cell division, 
                  increase blood supply to follicles, and extend the growth phase of the hair cycle.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-r from-pastel-pink/10 to-pastel-green/10 rounded-xl p-6">
                ...
                <p className="text-gray-700">
                  Over the following weeks and months, stimulated follicles begin producing new, stronger hair. 
                  Existing hair becomes thicker, and new hair growth appears. With multiple sessions, the 
                  cumulative effect leads to improved hair density, thickness, and overall hair quality.
                </p>
              </div>
            </div>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-r from-pastel-green/30 to-pastel-pink/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600">
              Book your ACP consultation with Dr. Jaishree today.
            </p>
