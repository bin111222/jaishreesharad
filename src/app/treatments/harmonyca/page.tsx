...
const treatmentAreas = [
  {
    area: "Cheeks",
    description: "Restores volume to sunken cheeks for a more youthful appearance",
  ...
  },
  {
    ...
    description: "Reduces lines around the mouth",
    benefit: "More youthful mouth area"
  },
  {
    area: "Jawline",
    description: "Enhances jawline definition",
    benefit: "Sharper, more defined jawline"
  },
  {
    area: "Hands",
    description: "Restores volume to aging hands",
    benefit: "Fuller, more youthful-looking hands"
  },
  {
    area: "Temples",
    description: "Fills hollow temples",
    benefit: "More balanced face shape"
  }
];

const faqs = [
  {
    question: "What is HarmonyCa and how does it work?",
    answer: "HarmonyCa contains calcium hydroxyapatite (CaHA) microspheres suspended in a gel carrier. Upon injection, the gel provides immediate volume restoration, while the CaHA microspheres stimulate your body's fibroblasts to produce new collagen over time. This dual-action approach provides both instant results and long-term collagen-stimulating benefits."
  },
  {
  ...
  {
    question: "Is HarmonyCa treatment painful?",
  ...
  {
    question: "Who is a good candidate for HarmonyCa?",
    answer: "Ideal candidates are adults experiencing volume loss in the face, particularly in the cheeks, nasolabial folds, or hands. HarmonyCa is suitable for all skin types and can be used as a standalone treatment or combined with other procedures. We'll assess your concerns during consultation."
  },
  {
    question: "How many sessions are needed?",
    answer: "Most patients achieve optimal results with 1-2 sessions, spaced 4-6 weeks apart. Touch-up sessions may be needed after 12-18 months for maintenance. The exact number depends on the degree of volume loss and desired outcome."
  },
  {
    question: "When will I see results?",
    answer: "You'll see immediate volume restoration right after treatment. Additional improvements develop over 2-3 months as new collagen forms around the CaHA microspheres, providing progressive enhancement. Results continue to improve for up to 6 months."
  },
  {
    question: "Is HarmonyCa painful?",
    answer: "Most patients experience mild to moderate discomfort during injection, similar to other dermal fillers. We can apply numbing cream or use a local anesthetic to ensure your comfort throughout the procedure. The injection technique can be adjusted to minimize discomfort."
  },
  {
    question: "Are there any side effects?",
    answer: "Common side effects include injection site reactions such as redness, swelling, bruising, and tenderness that typically resolve within a few days. Rare side effects may include small bumps or nodules. Serious side effects are rare when performed by an experienced provider."
  },
  {
    question: "How long do results last?",
    answer: "Results typically last 12-18 months. The immediate volume from the gel may last 6-12 months, while the collagen-stimulating effects provide longer-term improvements that can last 18 months or more. Maintenance treatments can help prolong results."
  }
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                HarmonyCa is an advanced dermal filler containing calcium hydroxyapatite (CaHA) microspheres suspended in a gel carrier. This unique formulation provides immediate volume restoration while simultaneously stimulating long-term collagen production, offering both instant and progressive results for comprehensive facial rejuvenation.
              </p>
            ...
            >
              <div className="bg-gradient-to-br from-pastel-green/30 to-pastel-pink/30 rounded-2xl p-8 aspect-square flex items-center justify-center overflow-hidden mb-6">
                <img 
                  src="https://ik.imagekit.io/jaishreeskinfinitii/websiteimages/harmonyca/harmonyca.webp"
                  alt="HarmonyCa treatment"
                    ...
                    e.currentTarget.parentElement!.innerHTML = `
                      <div class="w-full h-full bg-gradient-to-br from-pastel-green/30 to-pastel-pink/30 rounded-2xl flex items-center justify-center">
                        <div class="text-center">
                          ...
                          <p class="text-gray-600 font-medium">HarmonyCa</p>
                        </div>
                      </div>
                    `;
                  }}
          ...
          >
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                HarmonyCa can effectively restore volume to multiple areas of the face and hands, 
          ...
          >
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600">
                Understanding the science behind dual-action volume restoration
              </p>
            </div>
            
            <div className="space-y-6">
              <div className="bg-gradient-to-r from-pastel-green/10 to-pastel-pink/10 rounded-xl p-6">
                <h3 className="font-semibold text-lg text-gray-800 mb-3">1. Immediate Volume Restoration</h3>
                <p className="text-gray-700">
                  Upon injection, the gel carrier in HarmonyCa provides instant volume restoration. This gives you 
                  immediate results that you can see and feel right after treatment, addressing volume loss concerns 
                  immediately.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-r from-pastel-pink/10 to-pastel-green/10 rounded-xl p-6">
                ...
                <p className="text-gray-700">
                  The calcium hydroxyapatite (CaHA) microspheres in HarmonyCa create a scaffold that stimulates 
                  fibroblasts (cells that produce collagen) to begin producing new collagen. This process starts 
                  immediately but develops over time.
                </p>
              </div>
              
              <div className="bg-gradient-to-r from-pastel-green/10 to-pastel-pink/10 rounded-xl p-6">
                <h3 className="font-semibold text-lg text-gray-800 mb-3">3. Progressive Enhancement</h3>
                <p className="text-gray-700">
                  Over the following weeks and months, new collagen forms around the CaHA microspheres, creating 
                  additional volume and improving skin quality. This progressive enhancement ensures results continue 
                  to improve even after the initial gel volume begins to diminish.
                </p>
              </div>
              ...
              <div className="bg-gradient-to-r from-pastel-pink/10 to-pastel-green/10 rounded-xl p-6">
                ...
                <p className="text-gray-700">
                  The combination of immediate volume and long-term collagen production provides results that can 
                  last 12-18 months or longer. Since the new collagen is your body's own tissue, the results look 
                  natural and integrate seamlessly with your facial structure.
                </p>
              </div>
            </div>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-r from-pastel-green/30 to-pastel-pink/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600">
              Book your HarmonyCa consultation with Dr. Jaishree today.
            </p>
