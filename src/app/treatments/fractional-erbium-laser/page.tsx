        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-pastel-green/30 to-pastel-pink/30 rounded-2xl p-8 aspect-square flex items-center justify-center overflow-hidden mb-6">
                <img 
                  src="https://ik.imagekit.io/jaishreeskinfinitii/websiteimages/fractional-erbium-laser/fractional-erbium-laser.webp"
                  alt="Fractional Erbium Laser Treatment - Dr. Jaishree Sharad"
                  ...
                  onError={(e) => {
                    ...
                    e.currentTarget.parentElement!.innerHTML = `
                      <div class="text-center">
                        ...
                        <p class="text-gray-600 font-medium">Fractional Erbium Laser</p>
                      </div>
                    `;
                  }}
                />
