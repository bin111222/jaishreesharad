...
import { ArrowRight, Clock, User, Star, CheckCircle, AlertTriangle, Calendar, Sparkles, Zap, Target, Activity, Heart } from "lucide-react";
...
const skinTreatments = [
  {
    ...
    duration: "45-60 min",
    sessions: "1-6 sessions",
    results: "Immediate glow",
    icon: Sparkles,
    color: "from-blue-400 to-cyan-400",
    concerns: ["Dry skin", "Dullness", "Fine lines", "Uneven texture"]
  },
  {
    name: "LED Therapy",
  ...
  },
  {
    ...
    results: "Skin tightening",
    icon: Target,
    color: "from-green-400 to-emerald-400",
    concerns: ["Scars", "Wrinkles", "Large pores", "Texture"]
  },
  {
...
const faqs = [
  {
    ...
    answer: "We offer a comprehensive range of skin treatments including Hydrafacial, LED therapy, microneedling, chemical peels, and customized facials. Each treatment is tailored to your specific skin concerns and goals."
  },
  {
    question: "How do I know which treatment is right for me?",
    answer: "During your consultation, we'll assess your skin type, concerns, and goals to recommend the most suitable treatment plan. We may also suggest a combination of treatments for optimal results."
  },
  {
    question: "Are skin treatments painful?",
    answer: "Most skin treatments are comfortable and well-tolerated. We use numbing creams when needed and adjust treatment intensity based on your comfort level. You'll feel a mild sensation but not pain."
  },
  {
    question: "When will I see results?",
    answer: "Results vary by treatment type. Some treatments like Hydrafacial show immediate results, while others like microneedling show improvement over several weeks. Full results typically develop over 4-8 weeks."
  }
];
    ...
    <Layout>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                Transform your skin with our advanced treatments. 
                From deep cleansing to anti-aging solutions, 
                discover the perfect treatment for your skin concerns.
              </motion.p>
      ...
      <section className="py-12 bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {[
              { icon: Clock, label: "Duration", value: "20-90 min", color: "bg-pastel-green" },
              { icon: AlertTriangle, label: "Downtime", value: "Minimal", color: "bg-pastel-pink" },
              { icon: Calendar, label: "Results", value: "Immediate-8 weeks", color: "bg-pastel-green" },
              { icon: CheckCircle, label: "All Skin Types", value: "Yes", color: "bg-pastel-pink" }
            ].map((item, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 20 }}
      ...
      {/* Skin Treatments with Interactive Cards */}
          ...
          >
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600">
                Advanced solutions for all skin concerns
              </p>
            </div>
                ...
                >
                  <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-150">
                    <div className="w-full h-40 bg-gradient-to-br from-pastel-green/20 to-pastel-pink/20 rounded-xl mb-6 overflow-hidden">
                      <img 
                        src={`https://ik.imagekit.io/jaishreeskinfinitii/websiteimages/skintreatments/treatments/${treatment.name.toLowerCase().replace(/\s+/g, '-')}.webp`}
                        alt={`${treatment.name} skin treatment`}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600">
                Why choose professional skin care
              </p>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600">
                Common questions about skin treatments
              </p>
            </div>
      ...
      <section className="py-20 bg-gradient-to-r from-pastel-green/30 to-pastel-pink/30 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600">
              Book your skin consultation with Dr. Jaishree and discover 
